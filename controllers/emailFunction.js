...
module.exports = {
	sendWeeklyEmail: function sendWeeklyEmail(foundJobs) {
		cron.schedule('* * * * Monday', () => {
			//this works weekly. Uncomment for production
			...
			var data = {
				...
				to: emailing(foundJobs),
				subject: 'New Remote job Alert!',
				html: html.replace(/{{email}}/, emailing(foundJobs)),
			};
