...
router.get('/', function(req, res, next) {
	JobModel.find(function(err, jobs) {
		res.render('index', { title: 'DevAlert', contents: 'Your best spot for best dev jobs' });
	});
});
...
router.post('/email-subscription', Validation.validateEmail(), Validation.returnErrors, UserController.sendMail);
